...
const Welcome = withRouter(({ history }) => (
  <Fade in tag="div" timeout={300}>
    <main role="main" className="inner loginWelcome-cover">
      ...
      <p className="lead">
        <Button outline color="primary" onClick={() => history.push('/login/game-List')} size="lg">Join Game</Button>
        <Button outline color="primary" onClick={() => history.push('/login/host-game')} size="lg">Host Game</Button>
      </p>
    </main>
  </Fade>
));
