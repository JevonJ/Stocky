...
import { setRoom, setPlayer, initialize, setRoomInfo, setUser, setStartTime, setPlayerStocks } from '../actions';
...
export default connect(null, {
  setRoom, setPlayer, initialize, setRoomInfo, setUser, setStartTime, setPlayerStocks,
})(Main);
